...
(
  ...
  FOREIGN KEY (projectId) REFERENCES idea(id) ON DELETE CASCADE ON UPDATE CASCADE,
  CHECK(projectId IS NULL OR NOT isProject)
) ENGINE=InnoDB;
...
(
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  userId BIGINT UNSIGNED NOT NULL,
  dstUserId BIGINT UNSIGNED NOT NULL,
  included BOOLEAN NOT NULL,
  PRIMARY KEY (id),
